...
import { useRouter } from "next/router";
import { AiSearch } from "../Service/Services"; // Update with actual path
import VideoCard from "../Shared Components/search/VideoCard"; // Update with actual path
import SearchIcon from "@mui/icons-material/Search";
import AICard from "../Shared Components/search/AICard"; // Update with actual path
